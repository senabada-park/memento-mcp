...
/**
 * keyId를 단일 TEXT string으로 정규화한다.
 * - array 입력(그룹 사용자): 첫 멤버를 호출 주체로 가정하여 추출
 * - null/undefined: '-1' sentinel 반환 (마스터 키, NOT NULL 스키마 대응)
 * - 그 외: String() 캐스팅 (UUID 등 TEXT 컬럼 호환)
 */
function _normalizeKeyId(keyId) {
