...
export async function handleAuthorize(params) {
  ...
  console.log(`[OAuth] Authorization code issued for client: ${client_id?.substring(0, 8)}***`);
...
export async function handleToken(params) {
  ...
  console.log(`[OAuth] Access token issued for client: ${codeData.client_id?.substring(0, 8)}***`);
