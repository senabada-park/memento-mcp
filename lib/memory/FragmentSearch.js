...
export class FragmentSearch {
  ...
  async _executeSearch(sq, _metricsP) {
    ...
    if (sq.text && EMBEDDING_ENABLED) {
      ...
      combined = mergeRRFWithGraph(l1Ids, [...cached, ...l2Results], graphResults, l3Results, MEMORY_CONFIG.rrfSearch.k, MEMORY_CONFIG.rrfSearch.l1WeightFactor, MEMORY_CONFIG.rrfSearch.graphWeightFactor)
