...
| recall 응답에 _memento_hint 포함 | hint.trigger 도구 고려 | hint.suggestion 참조 (v2.12.0부터 _meta.hints[0]으로 이관 예정) |
| context 응답에 _memento_hint 포함 | hint.trigger 도구 고려 | hint.suggestion 참조 (v2.12.0부터 _meta.hints[0]으로 이관 예정) |
| recall 응답에 _suggestion 포함 | _suggestion.recommendedTool 검토 후 적용 | _suggestion.recommendedArgs 참조 (v2.12.0부터 _meta.suggestion으로 이관 예정) |
