...
`_suggestion` (v2.9.0+): A hint object generated by the RecallSuggestionEngine based on analysis of the current search pattern. `null` when no issue is detected.
