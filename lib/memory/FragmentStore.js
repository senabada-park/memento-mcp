...
export class FragmentStore {
  ...
  findCaseIdBySessionTopic(sessionId, topic)                           { return this.reader.findCaseIdBySessionTopic(sessionId, topic); }
  findErrorFragmentsBySessionTopic(sessionId, topic)                   { return this.reader.findErrorFragmentsBySessionTopic(sessionId, topic); }
  ...
  updateCaseId(fragmentId, caseId)                                     { return this.writer.updateCaseId(fragmentId, caseId); }
