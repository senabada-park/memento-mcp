...
| recall 응답에 _memento_hint 포함 | hint.trigger 도구 고려 | hint.suggestion 참조 (v3.0.0에서 _meta.hints[0]으로 이관 완료, top-level은 v3.1.0에서 제거 예정) |
| context 응답에 _memento_hint 포함 | hint.trigger 도구 고려 | hint.suggestion 참조 (v3.0.0에서 _meta.hints[0]으로 이관 완료, top-level은 v3.1.0에서 제거 예정) |
| recall 응답에 _suggestion 포함 | _suggestion.recommendedTool 검토 후 적용 | _suggestion.recommendedArgs 참조 (v3.0.0에서 _meta.suggestion으로 이관 완료, top-level은 v3.1.0에서 제거 예정) |
